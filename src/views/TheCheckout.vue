                ...
                <main class="col-xl-8 col-lg-8">
                    ...
                    <article class="card mb-4">
                        <div class="content-body">
                            <div class="float-end">
                                <a href="#" class="btn btn-outline-primary mr-1">Register</a>
                                ...
                                <div class="col-lg-4 mb-3">
                                    <div class="box box-check">
                                        <label class="form-check">
                                            <input class="form-check-input" type="radio" name="dostavka" checked="true">
                                            <b class="border-oncheck"></b>
                                            <span class="form-check-label">
                                                Express delivery <br>
                                                <small class="text-muted">3-4 days via Baab Delivery </small>
                                            </span>
                                        </label>
                                    </div>
                                </div> <!-- col end.// -->
                ...
                <aside class="col-xl-4 col-lg-4">
                    ...
                    <article class="ms-lg-4 mt-4 mt-lg-0" style="max-width: 320px">
                        ...
                        <dl class="dlist-align">
                            <dt>Total price:</dt>
                            <dd class="text-end"> Tsh 1,250,000</dd>
                        </dl>
                        <dl class="dlist-align">
                            <dt>Discount:</dt>
                            <dd class="text-end text-danger"> - Tsh 100,000 </dd>
                        </dl>
                        <dl class="dlist-align">
                            <dt>Shipping cost:</dt>
                            <dd class="text-end"> + Tsh 10,000 </dd>
                        </dl>
                        <hr>
                        <dl class="dlist-align">
                            <dt> Total: </dt>
                            <dd class="text-end"> <strong class="text-dark">Tsh 1,160,000</strong> </dd>
                        </dl>

                        <div class="input-group my-4">
                            <input type="text" class="form-control" name="" placeholder="Promo code">
                            <button class="btn btn-primary text-white">Apply</button>
                        </div>
                        ...
                        <figure class="itemside align-items-center mb-4">
                            ...
                            <figcaption class="info">
                                ...
                                <div class="price text-muted">Total: Tsh 230,000</div> <!-- price .// -->
                            </figcaption>
                        </figure>
                        ...
                        <figure class="itemside align-items-center mb-4">
                            ...
                            <figcaption class="info">
                                ...
                                <div class="price text-muted">Total: Tsh 340,000</div> <!-- price .// -->
                            </figcaption>
                        </figure>
                        ...
                        <figure class="itemside align-items-center mb-4">
                            <div class="aside">
                                ...
                                <img src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/1.jpg"
                                    class="img-sm rounded border">
                            </div>
                            <figcaption class="info">
                                <a href="#" class="title">GoPro HERO6 4K Action Camera - Black</a>
                                <div class="price text-muted">Total: Tsh 200,000</div> <!-- price .// -->
                            </figcaption>
                        </figure>
                    </article>
                    <!-- ============== COMPONENT SUMMARY .// =============== -->
